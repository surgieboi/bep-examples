...
- [NextJS + GraphCMS](https://github.com/dolapay/bep-examples/tree/main/with-next-graphcms)
- [NextJS + Contentful](https://github.com/dolapay/bep-examples/tree/main/with-next-contentful)
